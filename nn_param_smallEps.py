...
def train_NN(num_nodes, activation, X_train, X_val, y_train, y_val, learning_rate, sigma_sq, batch_size):
	...
	eps_1 = tf.random.normal(shape=[num_nodes,D_in],mean=0,stddev=0.01)
	eps_2 = tf.random.normal(shape=[num_nodes,num_nodes],mean=0,stddev=0.01)
	eps_3 = tf.random.normal(shape=[D_out,num_nodes],mean=0,stddev=0.01)
...
if __name__ == '__main__':
	...
	os.chdir(main_dir)
	f = open('param_crossVal_smallEps.txt', 'a')
